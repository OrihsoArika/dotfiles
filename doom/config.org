...
* Literate Emacs configuration file :3€
...
(setq doom-font (font-spec :family "BlexMono Nerd Font" :size 18)
      doom-variable-pitch-font (font-spec :family "Inter" :size 24))
...
(defun ispell-setup()
  ...
  (setq ispell-dictionary "en_GB,es_VE,nb_NO")

  (ispell-set-spellchecker-params)
  (ispell-hunspell-add-multi-dic "en_GB,es_VE,nb_NO")
  (ispell-change-dictionary "en_GB,es_VE,nb_NO" t)
...
(custom-theme-set-faces!
  'doom-rose-pine-dawn
  '(org-level-3 :inherit outline-3 :height 1.125)
...
(map! :n "SPC t t" telega-prefix-map)
;; end

;; Fix 'evil-mode' cursor behaviour
(map! :nmvo "<remap> <evil-next-line>" 'evil-next-visual-line)
(map! :nmvo "<remap> <evil-previous-line>" 'evil-previous-visual-line)
(setq-default evil-cross-lines t)

(map! :n "SPC j" 'move-text-down)
(map! :n "SPC k" 'move-text-up)
