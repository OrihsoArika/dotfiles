...
# ls aliases
alias fastfetch="fastfetch -c ~/.config/fastfetch/fastfetch/presets/examples/13.jsonc"
alias lsA="ls --color=auto -lA --sort=extension"

alias bspwm-config="nvim ~/.config/bspwm"
alias polybar-config="nvim ~/.config/polybar"
alias rofi-config="nvim ~/.config/rofi"
alias alacritty-config="nvim ~/.config/alacritty"
alias sxhkd-config="nvim ~/.config/sxhkd/sxhkdrc"
